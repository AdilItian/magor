const parseStm = require('./stm-parser');
const parseYTVTT = require('./ytvtt-parser');
					...
					for (imageSegment of imageCaptionList.ImageSegment) {
						imageSegments.push(
							raw
								...
								: `${secondsToTimeStamp(imageSegment.$.stime)} [${
										imageSegment._
								  }]`,
						);
					}
					...
					for (soundSegment of soundCaptionList.SoundSegment) {
						soundSegments.push(
							raw
								...
								: `${secondsToTimeStamp(soundSegment.$.stime)} [${
										soundSegment._
								  }]`,
						);
					}
